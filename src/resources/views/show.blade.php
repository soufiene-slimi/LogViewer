...
@section('content')
    <h1 class="page-header">Log [{{ $log->date }}]</h1><br><br>
                            ...
                            <div class="input-group">
                                ...
                                <span class="input-group-btn">
                                    @if (request()->has('query'))
                                        <a href="{{ route('log-viewer::logs.show', [$log->date]) }}" class="btn btn-default"><i class="fa fa-remove"></i></a>
                                    @endif
                    ...
                    <table id="entries" class="table table-condensed">
                        ...
                        <tbody>
                            @forelse($entries as $key => $entry)
                                <tr>
                                    <td>
                                        <span class="badge label-env">{{ $entry->env }}</span>
                                    </td>
                                    <td>
                                    ...
                                    <td class="text-right">
                                        @if ($entry->hasStack())
                                            <a class="btn btn-pill btn-block btn-sm btn-secondary collapsed" role="button" data-toggle="collapse" href="#log-stack-{{ $key }}" aria-expanded="false" aria-controls="log-stack-{{ $key }}">
